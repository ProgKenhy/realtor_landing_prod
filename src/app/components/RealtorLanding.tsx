        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Более 8 лет я профессионально сопровождаю сделки с недвижимостью в Санкт-Петербурге.
              Моя экспертиза позволяет клиентам избежать типичных рисков и переплат.
              Я выстраиваю всю цепочку: от анализа рынка и правильной оценки объекта (или подбора вариантов) до юридической проверки документов и успешного завершения сделки.
              Ваши интересы и безопасность — мой главный приоритет.
            </p>
          </div>
      ...
      <section id="contact" className="py-20 bg-gradient-to-br from-orange-600 to-red-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-orange-100 mb-8">
            Свяжитесь со мной любым удобным способом. Звоните в любое время! 💫
          </p>
